...
My research interests focus on deep learning, computer vision, large language models (LLM), and natural language processing (NLP). Recently, I have been dedicated to:
(1) 3D Point Cloud Segmentation
(2) Time-Varying Denoising Model Based on Diffusion Process
